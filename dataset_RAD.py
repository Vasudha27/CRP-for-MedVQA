...
def _load_dataset(dataroot, name, img_id2val, label2ans):
    ...
    answer_path = os.path.join(dataroot, 'n_cache', '%s_target.pkl' % name)
...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, args, dictionary, dataroot='data', question_len=12):
        ...
        ans2label_path = os.path.join(dataroot, 'n_cache', 'trainval_ans2label.pkl')
        label2ans_path = os.path.join(dataroot, 'n_cache', 'trainval_label2ans.pkl')
