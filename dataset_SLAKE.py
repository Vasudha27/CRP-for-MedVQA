...
def _load_dataset(dataroot, name, img_id2val, label2ans):
    ...
    samples = json.load(open(data_path, encoding="utf8"))
    samples = list(filter(lambda x: x['q_lang']=='en',samples))
    ...
    for sample, answer in zip(samples, answers):
        ...
        utils.assert_eq(sample['img_name'], answer['image_name'])
...
class VQAFeatureDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if None!=answer:
            ...
            return image_name, image_data, qid, question, target, answer_type, question_type, phrase_type
